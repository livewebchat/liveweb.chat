          ...
          <div className="card-body d-flex align-items-center py-8">
            ...
            <div className="ms-6">
              ...
              <p className="list-unstyled text-gray-600 fw-semibold fs-6 p-0 m-0">
                ...
                <code>src/_metronic/layout/core/DefaultLayoutConfig.ts</code>{" "}
                file). Don't forget clear your local storage when you are
                changing DefaultLayoutConfig.
              </p>
            </div>
            {/* end::Description */}
          </div>
          ...
          <form className="form">
            ...
            <div className="card-body">
              <div className="tab-content pt-3">
                ...
                <div
                  className={clsx("tab-pane", { active: tab === "Content" })}
                >
                  <div className="row mb-10">
                    <label className="col-lg-3 col-form-label text-lg-end">
                      Width:
